...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        # Detect artwork and prepare normalized PNG for display only.
        # We do NOT mutate TrackPlan here to avoid dataclass/frozen/type pitfalls.
        rows = []
        for plan in plans:
