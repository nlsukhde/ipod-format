...
class DropList(QtWidgets.QListWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Fallback placeholder overlay (works across Qt versions)
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.btn_preview.setEnabled(False)  # wired in GUI-2
        self.btn_start = QtWidgets.QPushButton("Start")
        self.btn_start.setEnabled(False)     # wired in GUI-2
    ...
    def _update_buttons(self) -> None:
        ...
        # will flip to True in GUI-2 when wired
        self.btn_start.setEnabled(False)
        self.btn_preview.setEnabled(has_items)
        self.btn_clear.setEnabled(has_items)
        # Also keep the placeholder updated (in case queue modified externally)
    ...
    # ========== Settings snapshot for pipeline (used in GUI-2) ==========
