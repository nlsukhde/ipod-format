...
@dataclass(frozen=True)
class ArtSource:
    """Where cover art will come from for this track."""
    kind: Literal["embedded", "folder", "none"]
    # For 'embedded'
    stream_index: Optional[int] = None
    # For 'folder'
    file_path: Optional[Path] = None
    # Normalized, temp PNG (populated after normalization step)
    normalized_png: Optional[Path] = None
    # For display
    detail: str = ""
...
class TrackPlan:
    ...
    art_source: ArtSource = ArtSource(kind="none")
